...
const DEMO_ARTICLES: DemoArticleDef[] = [
  ...
  {
    brandKey: 'ukrbuild',
    title: 'UkrBuild заходить у Дніпро й Запоріжжя',
    excerpt: 'Будівельна компанія розповідає про нову рекламну присутність на Придніпров\'ї.',
    content:
      'UkrBuild зайняла Дніпропетровську область, місто Дніпро та Запорізьку область. Регіон активно ' +
      'забудовується, і ми хочемо, щоб наш бренд асоціювався з якісним будівництвом саме тут — а не лише ' +
      'на рекламних щитах, а й на реальних об\'єктах, які вже здаємо в експлуатацію.',
    hoursAgo: 60,
  },
  {
    brandKey: 'quickcourier',
    title: 'QuickCourier розширює доставку на Черкащину',
    excerpt: 'Кур\'єрська служба розповідає, чому обрала Черкаську область для нової рекламної локації.',
    content:
      'QuickCourier зайняв Черкаську область — регіон із зручною логістикою між Києвом і Дніпром, що дозволяє ' +
      'скоротити час доставки для клієнтів по всій центральній Україні. Далі плануємо додати ще кілька ' +
      'областей уздовж цього маршруту.',
    hoursAgo: 15,
  },
]
